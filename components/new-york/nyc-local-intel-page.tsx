...
export function NycIntelPage({ snapshot }: { snapshot: NycContractorSnapshot }) {
  const s = snapshot;
  const L = s.licenses;
  ...
  return (
    <main className="mx-auto w-full max-w-[880px] overflow-x-clip px-4 py-8 sm:px-6 sm:py-10">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[var(--muted)]">
        ...
        exact Business Unique ID or license number. This is not a ranking, recommendation, Trust
        Score, DOB contractor registry, or statewide NYSDOL public-work roster.
      </p>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          ...
          archives, DOB/PLUTO, ACRIS, and suburban counties were not acquired in this ticket.
        </p>
        <Trace
