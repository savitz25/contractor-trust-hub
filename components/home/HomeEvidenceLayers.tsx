const LAYERS = [
  ["01", "Identity", "License, registration, or official business identity", "Accepted state intelligence sources", "Distinguishes an exact public identity from a similar name.", "Identity does not establish quality or service area."],
  ...
  ["04", "Work history", "Permit, public-work, or attributable activity evidence", "Selected state and local modules; see the evidence inventory", "Separates performed or attributed activity from credential status.", "Permit activity does not prove quality or completion."],
  ["05", "Regulatory history", "Discipline, enforcement, unlicensed activity, and debarment", "Depth varies by state and source", "Surfaces official records that merit direct review.", "No row is not a clean record; discipline is not a criminal conviction."],
