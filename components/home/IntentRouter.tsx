...
const intents = [
  {
    ...
    bestWhen: "Best when you already have a name or license number.",
    bullets: ["Search by license or company", "Open a Trust Report"],
  ...
  },
  {
    ...
    bestWhen: "Best when you're deciding scope and what it may cost.",
    bullets: ["Plan flow and Project Studios", "Scope + cost context"],
    cta: "Start planning",
    accent: true,
  },
  {
    ...
    bestWhen: "Best when you want property or permit context first.",
    bullets: ["Property permit research", "Permit planner handoff"],
    cta: "Check address",
    accent: false,
  },
] as const;
