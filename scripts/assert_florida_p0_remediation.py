...
def main() -> int:
    ...
    schema = read("schema/migrations/010_qualifier_graph.sql")
    regpub = read("lib/regulatory/publication.ts")
    ...
    assert_("PUBLIC_FL_DISCIPLINE_PREDICATE" in attr, "Intelligence discipline PUBLIC gate")
    assert_("PUBLIC_ELIGIBLE" in regpub or "publication_state" in queries, "production regulatory publication gate intact")
