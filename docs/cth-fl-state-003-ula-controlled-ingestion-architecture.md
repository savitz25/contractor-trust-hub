...
## Production ULA ingestion execution

CTH-FL-STATE-003 executed the approved production transaction on 2026-08-24 from canonical main `73d30ad12ca9bd3d64f0164959274338332dd162`. The executor began at `2026-08-24T15:59:04.6673352Z` and confirmed successful completion/commit at `2026-08-24T15:59:28.9487193Z`; the latter is executor completion confirmation because native PostgreSQL commit timestamp tracking was unavailable.

The transaction acquired the dataset advisory lock and inserted exactly five batches, 11,691 standalone ULA actions, 11,691 immutable source observations, and 11,691 occurrences—35,078 inserts with no updates or deletes. Every ULA row is `UNRESOLVED` using `NO_OFFICIAL_IDENTITY_IDENTIFIER`; license, contractor, resolved-license, candidate-identity, and publication links are zero. All 11,691 observations are CURRENT, payload/hash and source-key checks pass 11,691/11,691, and fiscal occurrence counts match the five approved files.

Independent post-commit verification on a new read-only connection confirmed 19,741 whole discipline actions, 18,148 Florida actions, 18,148 observations and occurrences, and 56 batches. All eight actual fingerprints equal their approved predictions. The 6,457 licensed-discipline cohort, 1,972 safe links, Arizona, and New Jersey remain unchanged. Florida PUBLIC_ELIGIBLE and contractor-linked ULA rows remain zero, the publication gate remains absent/off, and public/site health checks pass without observed database errors.

The canonical reverse manifest remains preserved at `sha256:12e45eb92796c989ea499a2c983a81ce1523510e4413eebc02bb865a9d1be2a1`. Automatic rollback is not authorized. Recovery Fund, workers compensation, stop-work data, DOAH enrichment, county data, Google APIs, contacts, and canonical-address promotion were not touched.
