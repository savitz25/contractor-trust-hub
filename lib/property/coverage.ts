...
const MATRIX: JurisdictionCoverage[] = [
  ...
  // Wave B — next top metros
  {
    ...
    note: "Partial Wave B depth — denser extract than pilot; still incomplete. Municipal AHJs common.",
    sampleRecordCount: 6,
    freshness: "2026-04-10",
  },
  {
    ...
    note: "Partial Wave B depth — denser extract than pilot; still incomplete.",
    sampleRecordCount: 5,
    freshness: "2026-04-10",
  },
  {
  ...
  // Wave C — additional high-demand
  {
    ...
    note: "Partial Wave C depth — denser extract than pilot; still incomplete.",
    sampleRecordCount: 5,
    freshness: "2026-04-10",
  },
  {
